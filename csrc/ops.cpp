...
torch::Tensor fused_logp_sm90_forward(torch::Tensor logits,
                                      torch::Tensor labels);
std::vector<torch::Tensor>
fused_linear_logp_sm90_forward(torch::Tensor hidden, torch::Tensor weight,
                               torch::Tensor target,
                               torch::optional<torch::Tensor> bias,
                               torch::optional<torch::Tensor> temperature,
                               bool return_logits, int64_t real_vocab_size);
std::vector<torch::Tensor>
batch_invariant_logp_sm90_forward(torch::Tensor logits, torch::Tensor target,
...
std::vector<torch::Tensor> fused_linear_logp_sm90_backward(
    torch::Tensor grad_logp, torch::Tensor hidden, torch::Tensor weight,
    torch::Tensor target, torch::Tensor lse,
    torch::optional<torch::Tensor> bias, int64_t vocab_start_index,
    bool compute_grad_hidden, bool compute_grad_weight, bool compute_grad_bias,
    bool use_global_lse);
std::vector<torch::Tensor>
linear_logp_probs_bf16_forward(torch::Tensor logits, torch::Tensor target,
                               int64_t vocab_start_index);
std::vector<torch::Tensor> linear_logp_bf16_forward(torch::Tensor logits,
                                                    torch::Tensor target,
                                                    int64_t vocab_start_index);
std::vector<torch::Tensor>
linear_logp_local_probs_bf16_forward(torch::Tensor logits, torch::Tensor target,
                                     int64_t vocab_start_index);
std::vector<torch::Tensor>
linear_logp_local_bf16_forward(torch::Tensor logits, torch::Tensor target,
                               int64_t vocab_start_index);
torch::Tensor linear_logp_probs_bf16_to_dlogits_(torch::Tensor probs,
                                                 torch::Tensor target,
                                                 torch::Tensor grad_logp,
                                                 int64_t vocab_start_index);
torch::Tensor linear_logp_local_probs_bf16_to_dlogits_(
    torch::Tensor probs, torch::Tensor target, torch::Tensor grad_logp,
    torch::Tensor local_lse, torch::Tensor global_lse,
    int64_t vocab_start_index);
torch::Tensor linear_logp_logits_bf16_to_dlogits(
    torch::Tensor logits, torch::Tensor dlogits, torch::Tensor target,
    torch::Tensor grad_logp, torch::Tensor lse, int64_t vocab_start_index);
// RoPE (rotate-half) apply for SM90; cos/sin precomputed fp32, sin_sign = +1
// fwd / -1 bwd.
torch::Tensor rope_apply_sm90(torch::Tensor x, torch::Tensor cos,
                              torch::Tensor sin, double sin_sign);
torch::Tensor embedding_sm90_forward(torch::Tensor token_ids,
                                     torch::Tensor weight);
torch::Tensor embedding_sm90_forward_fp32(torch::Tensor token_ids,
                                          torch::Tensor weight);
...
torch::Tensor fused_logp_forward_out(torch::Tensor logits,
                                     torch::Tensor token_ids,
                                     torch::Tensor output);
torch::Tensor fused_logp_forward_fp32(torch::Tensor logits,
                                      torch::Tensor token_ids);
torch::Tensor fused_logp_forward_indexed_out(torch::Tensor logits,
                                             torch::Tensor token_ids,
                                             torch::Tensor row_indices,
                                             torch::Tensor output);
torch::Tensor fused_logp_forward_indexed_fp32(torch::Tensor logits,
                                              torch::Tensor token_ids,
                                              torch::Tensor row_indices);
torch::Tensor fused_logp_forward_online_out(torch::Tensor logits,
                                            torch::Tensor token_ids,
                                            torch::Tensor output);
torch::Tensor fused_logp_forward_online_fp32(torch::Tensor logits,
                                             torch::Tensor token_ids);
torch::Tensor fused_logp_forward_online_indexed_out(torch::Tensor logits,
                                                    torch::Tensor token_ids,
                                                    torch::Tensor row_indices,
                                                    torch::Tensor output);
torch::Tensor fused_logp_forward_online_indexed_fp32(torch::Tensor logits,
                                                     torch::Tensor token_ids,
                                                     torch::Tensor row_indices);
torch::Tensor deterministic_logp_forward(torch::Tensor logits,
                                         torch::Tensor token_ids);
torch::Tensor deterministic_logp_forward_out(torch::Tensor logits,
                                             torch::Tensor token_ids,
                                             torch::Tensor output);
torch::Tensor deterministic_logp_forward_fp32(torch::Tensor logits,
                                              torch::Tensor token_ids);
torch::Tensor deterministic_logp_forward_indexed_out(torch::Tensor logits,
                                                     torch::Tensor token_ids,
                                                     torch::Tensor row_indices,
                                                     torch::Tensor output);
torch::Tensor deterministic_logp_forward_indexed_fp32(
    torch::Tensor logits, torch::Tensor token_ids, torch::Tensor row_indices);
std::vector<torch::Tensor> deterministic_logp_tile_stats(torch::Tensor logits,
                                                         int64_t vocab_start,
                                                         int64_t real_vocab,
                                                         int64_t num_tiles);
torch::Tensor
deterministic_logp_backward(torch::Tensor logits, torch::Tensor lse,
                            torch::Tensor coef_logp, torch::Tensor coef_lse,
                            torch::Tensor target_local, int64_t vocab_start,
                            int64_t real_vocab, bool has_lse_grad);

// ROCm-tuned WS2 vocab-parallel logprob kernels
// (csrc/hip/hip_deterministic_logp_kernel.hip).
#if defined(__HIPCC__) || defined(__HIP_PLATFORM_AMD__)
std::vector<torch::Tensor>
hip_deterministic_logp_tile_stats(torch::Tensor logits, int64_t vocab_start,
                                  int64_t real_vocab, int64_t num_tiles);
torch::Tensor
hip_deterministic_logp_backward(torch::Tensor logits, torch::Tensor lse,
                                torch::Tensor coef_logp, torch::Tensor coef_lse,
                                torch::Tensor target_local, int64_t vocab_start,
                                int64_t real_vocab, bool has_lse_grad);
#endif
...
deterministic_collective_ipc_meta(torch::Tensor &tensor);
int64_t deterministic_collective_create(
    torch::Tensor &staging, const std::vector<std::vector<int64_t>> &handles,
...
void deterministic_collective_all_reduce_fused(int64_t handle,
                                               torch::Tensor &input,
                                               torch::Tensor &output);
void deterministic_collective_reduce_scatter(int64_t handle,
                                             torch::Tensor &output);
void deterministic_collective_all_gather(int64_t handle, torch::Tensor &output);
void deterministic_collective_all_gather_fused(int64_t handle,
                                               torch::Tensor &input,
                                               torch::Tensor &output);
#endif
...
void deterministic_collective_rocm_all_reduce(torch::Tensor rank_inputs,
                                              torch::Tensor output);
void deterministic_collective_rocm_reduce_scatter(torch::Tensor rank_inputs,
                                                  torch::Tensor output);
...
void deterministic_collective_rocm_ipc_stage(int64_t handle,
                                             torch::Tensor input);
void deterministic_collective_rocm_ipc_all_reduce(int64_t handle,
                                                  torch::Tensor output);
void deterministic_collective_rocm_ipc_all_reduce_input(int64_t handle,
                                                        torch::Tensor input,
                                                        torch::Tensor output);
void deterministic_collective_rocm_ipc_reduce_scatter(int64_t handle,
                                                      torch::Tensor output);
...
void deterministic_collective_rocm_ipc_reduce_scatter_many(
    int64_t handle, const std::vector<torch::Tensor> &inputs,
    const std::vector<torch::Tensor> &outputs);
void deterministic_collective_rocm_ipc_all_gather(int64_t handle,
                                                  torch::Tensor output);
void deterministic_collective_rocm_ipc_all_gather_input(int64_t handle,
                                                        torch::Tensor input,
                                                        torch::Tensor output);
#endif
...
std::vector<torch::Tensor>
swiglu_backward_cuda(torch::Tensor dy, torch::Tensor gate, torch::Tensor up);
torch::Tensor swiglu_packed_forward_cuda(torch::Tensor gate_up);
std::vector<torch::Tensor> swiglu_packed_backward_cuda(torch::Tensor dy,
                                                       torch::Tensor gate_up);

// RMSNorm Declarations & Wrappers

void rmsnorm_forward_cuda(torch::Tensor x, torch::Tensor weight,
                          torch::Tensor y, torch::Tensor rstd, double eps);

void rmsnorm_backward_dx_cuda(torch::Tensor dy, torch::Tensor x,
                              torch::Tensor weight, torch::Tensor rstd,
                              torch::Tensor dx);

void rmsnorm_backward_partial_dw_cuda(torch::Tensor dy, torch::Tensor x,
                                      torch::Tensor rstd, torch::Tensor mask,
                                      torch::Tensor partial_dw);

void rmsnorm_backward_reduce_dw_cuda(torch::Tensor partial_dw,
                                     torch::Tensor dw);
...
std::vector<torch::Tensor> rmsnorm_forward(torch::Tensor x,
  ...
  TORCH_CHECK(x.size(1) == weight.size(0),
              "x.size(1) must equal weight.size(0)");
...
torch::Tensor rmsnorm_backward_dx(torch::Tensor dy, torch::Tensor x,
                                  torch::Tensor weight, torch::Tensor rstd) {
...
torch::Tensor rmsnorm_backward_dw(torch::Tensor dy, torch::Tensor x,
                                  torch::Tensor rstd, torch::Tensor mask) {
  rmsnorm_check_input(dy, "dy");
  rmsnorm_check_input(x, "x");
  rmsnorm_check_input(rstd, "rstd");
  ...
  auto partial_dw =
      torch::empty({chunks, H}, x.options().dtype(torch::kFloat32));
...
torch::Tensor silu_forward(torch::Tensor x) { return silu_forward_cuda(x); }
...
std::vector<torch::Tensor> swiglu_backward(torch::Tensor dy, torch::Tensor gate,
                                           torch::Tensor up) {
...
std::vector<torch::Tensor> swiglu_packed_backward(torch::Tensor dy,
                                                  torch::Tensor gate_up) {
...
std::vector<torch::Tensor> deterministic_attention_forward(
    ...
    double scale, torch::optional<torch::Tensor> key_padding_mask);

std::vector<torch::Tensor> deterministic_attention_backward(
    torch::Tensor grad_output, torch::Tensor q, torch::Tensor k,
    torch::Tensor v, torch::Tensor P, bool causal, double scale,
    torch::optional<torch::Tensor> key_padding_mask);

#if defined(KERNEL_ALIGN_WITH_ROCM)
torch::Tensor deterministic_rope_apply_rocm(torch::Tensor x, torch::Tensor cos,
                                            torch::Tensor sin, double sin_sign);
#endif
...
at::Tensor prefix_shared_attention(const at::Tensor &Q, const at::Tensor &K,
                                   const at::Tensor &V) {
  ...
  TORCH_CHECK(Q.is_cuda() && Q.is_contiguous(),
              "Tensors must be CUDA and contiguous");
  TORCH_CHECK(K.is_cuda() && K.is_contiguous(),
              "Tensors must be CUDA and contiguous");
  TORCH_CHECK(V.is_cuda() && V.is_contiguous(),
              "Tensors must be CUDA and contiguous");
  ...
  prefix_shared_attention_forward(Q_ptr, K_ptr, V_ptr, O_ptr, bs, G, len_q,
                                  len_kv, dim);
...
std::vector<torch::Tensor>
mhc_rmsnorm_residual_forward(torch::Tensor x, torch::Tensor gamma, double eps);
...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
...
#if defined(__CUDACC__) || defined(KERNEL_ALIGN_WITH_SM90)
  m.def("fused_logp_sm90", &fused_logp_sm90_forward,
        "TMA-accelerated Online Softmax Fused LogP");
  m.def("fused_linear_logp_sm90", &fused_linear_logp_sm90_forward,
        "TMA+WGMMA fused linear log-prob (hidden @ W^T -> selected-token "
        "logp), SM90; "
        "frozen reduction contract with optional temperature, logits, and "
        "real-vocab mask",
  ...
  m.def("batch_invariant_logp_sm90", &batch_invariant_logp_sm90_forward,
        "TMA online-softmax batch-invariant selected-token log-prob from "
        "logits, SM90");
  m.def("fused_linear_logp_sm90_global_target",
        &fused_linear_logp_sm90_global_target_forward,
        "TMA+WGMMA local-shard target-logit/lse for vocab-parallel linear "
        "log-prob, SM90",
        py::arg("hidden"), py::arg("weight"), py::arg("target"),
  ...
  m.def("linear_logp_probs_bf16_forward", &linear_logp_probs_bf16_forward,
        "Build bf16 softmax probabilities and selected log-prob from bf16 "
        "logits");
  m.def("linear_logp_bf16_forward", &linear_logp_bf16_forward,
        "Build selected log-prob and lse from bf16 logits without saving "
        "probabilities");
  m.def("linear_logp_local_probs_bf16_forward",
        &linear_logp_local_probs_bf16_forward,
        "Build local bf16 softmax probabilities, target logits, and lse from "
        "bf16 logits");
  m.def("linear_logp_local_bf16_forward", &linear_logp_local_bf16_forward,
        "Build local target logits and lse from bf16 logits without saving "
        "probabilities");
  ...
  // RoPE rotate-half apply, SM90 (forward and backward share the kernel via
  // sin_sign)
  m.def("rope_apply_sm90", &rope_apply_sm90,
        "RoPE rotate-half apply (GPT-NeoX), SM90");
  ...
  m.def("fused_logp_forward_indexed_out", &fused_logp_forward_indexed_out,
        "Fused logp indexed out");
  m.def("fused_logp_forward_indexed_fp32", &fused_logp_forward_indexed_fp32,
        "Fused logp indexed fp32");
  m.def("fused_logp_forward_online_out", &fused_logp_forward_online_out,
        "Fused logp online out");
  m.def("fused_logp_forward_online_fp32", &fused_logp_forward_online_fp32,
  ...
  m.def("deterministic_logp", &deterministic_logp_forward,
        "Batch-invariant deterministic logp");
  m.def("deterministic_logp_forward_out", &deterministic_logp_forward_out,
        "Batch-invariant deterministic logp out");
  m.def("deterministic_logp_forward_fp32", &deterministic_logp_forward_fp32,
  ...
  m.def(
      "deterministic_logp_backward", &deterministic_logp_backward,
  ...
  m.def("hip_deterministic_logp_tile_stats", &hip_deterministic_logp_tile_stats,
        "ROCm-tuned vocab-tile FP32 max and sumexp partials read from the "
        "stored shard");
  m.def("hip_deterministic_logp_backward", &hip_deterministic_logp_backward,
        "ROCm fused vocab-parallel selected-logprob/LSE backward on the local "
        "shard");
#endif
  ...
  m.def("deterministic_collective_rocm_reduce_scatter",
  ...
  m.def("deterministic_collective_rocm_ipc_reduce_scatter_many",
        ...
        "Run multiple ROCm IPC fixed-tree reduce-scatters with one "
        "synchronization");
  ...
  m.def("det_gemm_sm90_compiled", &det_gemm_sm90_compiled,
        "Whether the extension contains the SM90 deterministic GEMM "
        "implementation");
  m.def("det_gemm_fwd", &det_gemm_fwd,
        "Batch-invariant deterministic GEMM forward (C=A@B)");
  ...
  m.def("det_gemm_da", &det_gemm_da,
        "Batch-invariant deterministic GEMM backward dA (dC@B^T)");
  m.def("det_gemm_db", &det_gemm_db,
        "Batch-invariant deterministic GEMM backward dB (A^T@dC)");
  m.def(
      "det_gemm_db_transposed", &det_gemm_db_transposed,
      "Batch-invariant deterministic GEMM backward in canonical [N,K] layout");
  // registry RMSNorm
  m.def("rmsnorm_forward", &rmsnorm_forward,
        "Batch-invariant RMSNorm forward CUDA");
  m.def("rmsnorm_backward_dx", &rmsnorm_backward_dx,
        "Batch-invariant RMSNorm backward dx CUDA");
  m.def("rmsnorm_backward_dw", &rmsnorm_backward_dw,
        "Deterministic RMSNorm backward dweight CUDA");
#if !defined(USE_ROCM)
  m.def("reduce_rows_fp32_left_fold", &reduce_rows_fp32_left_fold,
  ...
  m.def("swiglu_forward", &swiglu_forward,
        "Batch-invariant SwiGLU forward CUDA");
  m.def("swiglu_backward", &swiglu_backward,
        "Batch-invariant SwiGLU backward CUDA");
  ...
  // Deterministic standard-softmax attention (issue #147)
  m.def("deterministic_attention_forward", &deterministic_attention_forward,
...
#if defined(KERNEL_ALIGN_WITH_ROCM)
  m.def("deterministic_rope_apply_rocm", &deterministic_rope_apply_rocm,
