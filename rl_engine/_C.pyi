...
def det_gemm_fwd_out_fp32(a: torch.Tensor, b: torch.Tensor) -> torch.Tensor: ...
def det_gemm_fwd_rhs_transposed_out_fp32(
    a: torch.Tensor,
    bt: torch.Tensor,
) -> torch.Tensor: ...
...
def mxfp8_act_quant_forward(
    x: torch.Tensor, check_finite: bool = True
) -> tuple[torch.Tensor, torch.Tensor, torch.Tensor]: ...
def mxfp8_act_quant_ste_backward(dy: torch.Tensor) -> torch.Tensor: ...
def rmsnorm_forward(
    x: torch.Tensor,
    weight: torch.Tensor,
    eps: float,
