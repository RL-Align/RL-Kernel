...
def deterministic_collective_reduce_scatter(
...
def embedding_sm90_forward(
    token_ids: torch.Tensor, weight: torch.Tensor
) -> torch.Tensor: ...
def embedding_sm90_forward_fp32(
    token_ids: torch.Tensor, weight: torch.Tensor
) -> torch.Tensor: ...
...
def deterministic_collective_rocm_ipc_stage(
